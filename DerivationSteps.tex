...
\section{Overall Picture of Classical Mechanics, Connections with other Areas}
	...
	The separation of Physics into distinct areas that are disconnected from each other leads students to believe that these areas are completely different. This is simply not the case. Every area of study in Physics has more in common with others than not. 
