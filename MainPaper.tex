...
\end{assump}
	...
	A system undergoes deterministic and reversible evolution if there is a bijection from past states to future states. This is a necessary but not sufficient condition for our definition of this kind of evolution. 
	
	Imagine we have a damped harmonic oscillator. In a classical system we have a one to one/injective (and onto/surjective) map from past states to future states. But we also no 
