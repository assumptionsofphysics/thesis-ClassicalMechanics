...
\end{vmatrix}.$$
	...
	How does this generalize to higher dimensions? Recall from our distance/time example that we can change unit variables independently of one another. Let's consider the case where an arbitrary number of $q^i$ unit variables define our unit system. Now we can preform individual changes of unit variables. 
