...
\begin{defn}
	An degree of freedom (d.o.f.) is a pair $\{q^i,p_i \}$ such that $dS^i = dq^i \land dp_i$. $dS^i$ quantifies the number of possible states within a degree of freedom. The total number of possible states within an infinitesimal volume is given by $ product dS^i$.
\end{defn}
