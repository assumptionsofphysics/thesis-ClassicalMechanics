...
\end{assump}
	...
	\emph{Explain in practical term what reducibility is. Give examples and counterexamples. Ball and red marker. To remove: Electron and photon scattering. Example needs work.}
	 ...
	 Now to be clear we will still discuss the classical "particles" that make up a system but we should clarify our precise definition. They are simply the limit of recursive subdivision of our reducible material. These particles have an infinitesimal extent. They are not point particles. As we proceed understand that our definition of particle refers simply to very small regions of our homogeneous, reducible material.
